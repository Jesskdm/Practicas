...
<body>
    ...
    <?php
        ...
        $fuente= $_POST['fuente'];
        $temas_interes= isset($_POST['temas_interes']) ? implode(',',$_POST['temas_interes']):'No se selecciono ningun tema';
        $opciones= isset($_POST['opciones'])? implode(',',$_POST['opciones']):'Nose selecciono ninguna opción';
        ...
        echo"<p><strong>Opciones de Partición:</strong>$opciones</p>";
